...
export const UI = {
  ...
  projectCardPortrait: "flex-col lg:min-h-[600px] lg:flex-row lg:items-stretch",
  ...
  projectImagePortrait:
    "relative w-full max-w-[min(100%,420px)] mx-auto min-h-[380px] border-b border-zinc-800/50 sm:min-h-[420px] lg:mx-0 lg:min-h-full lg:w-1/2 lg:max-w-[50%] lg:border-b-0 lg:border-r lg:border-zinc-800/50",
  projectTag:
