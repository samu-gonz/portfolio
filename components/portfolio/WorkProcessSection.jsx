...
export default function WorkProcessSection() {
  return (
    <section id="proceso" aria-labelledby="proceso-title" className="space-y-6 sm:space-y-8 xl:space-y-10">
      <SectionHeader
      ...
      />
      <p className="max-w-2xl text-sm leading-relaxed text-zinc-400 sm:text-base xl:max-w-3xl 3xl:text-lg">
        Un proceso simple para que sepas qué ocurre en cada momento — sin tecnicismos ni sorpresas.
      </p>

      <ol className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 sm:gap-5 xl:gap-6">
        {PROCESS_STEPS.map((step, index) => (
          ...
          >
            ...
            <h3 className="mt-3 text-base font-semibold tracking-tight text-zinc-50 sm:text-lg 3xl:text-xl">
              {step.title}
            </h3>
