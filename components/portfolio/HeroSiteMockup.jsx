...
export default function HeroSiteMockup() {
  ...
  return (
    <figure className="min-w-0 xl:mb-0 xl:mt-0" aria-label={STUDIO_SITE_MOCKUP.alt}>
      <div className="overflow-hidden rounded-2xl border border-zinc-700/70 bg-zinc-950 shadow-[0_18px_50px_rgba(0,0,0,0.45)]">
        ...
        <div className="relative h-[180px] overflow-hidden bg-[#0b0f19] sm:h-auto sm:aspect-[16/10] xl:max-h-[420px] 3xl:max-h-[480px]">
          {failed ? (
