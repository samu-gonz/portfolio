...
export const UI = {
  ...
  projectCardPortrait: "flex-col lg:flex-row lg:items-start",
  ...
  projectImagePortrait:
    "w-full max-w-[min(100%,340px)] mx-auto border-b border-zinc-800/50 bg-zinc-950/40 lg:mx-0 lg:w-[min(38%,300px)] lg:max-w-[320px] lg:self-start lg:border-b-0 lg:border-r lg:border-zinc-800/50",
  projectTag:
