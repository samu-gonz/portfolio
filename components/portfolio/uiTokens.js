...
export const UI = {
  ...
  projectCard:
    "group flex flex-col overflow-hidden rounded-2xl border border-zinc-800/80 bg-zinc-900/20 shadow-[0_10px_36px_rgba(0,0,0,0.28)] transition duration-300 hover:border-zinc-700/70 hover:bg-zinc-900/45 hover:shadow-[0_22px_56px_rgba(0,0,0,0.48)] lg:flex-row lg:items-start",
  projectImage:
    "relative overflow-hidden border-b border-zinc-800/50 lg:border-b-0 lg:border-r lg:border-zinc-800/50",
  projectTag:
